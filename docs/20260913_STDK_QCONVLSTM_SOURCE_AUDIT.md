...
> 檢查與目前參數差異見
> [20260916_WEATHER2K_STDK_QCONVLSTM_SEED41_DIAGNOSTIC.md](20260916_WEATHER2K_STDK_QCONVLSTM_SEED41_DIAGNOSTIC.md)。
...
舊版調參資料夾：`weather2k_exp/air_temperature/20260912_qconvlstm_obs100_ema_tuning/`
...
- 舊版調參紀錄：`weather2k_exp/air_temperature/20260912_qconvlstm_obs100_ema_tuning/`
- STDK 對齊稽核：`docs/20260913_STDK_SPATIAL_ADAPTER_ALIGNMENT.md`
