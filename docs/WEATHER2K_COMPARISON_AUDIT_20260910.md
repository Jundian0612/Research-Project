...
| `qconvlstm_retune_rtx2000_20260909` | 新環境兩階段 q50 validation，seeds 41、42 | 不是正式 Test150；沒有新參數的五-seed 正式結果 |
...
**8/01 `results_svgp_tuned_stationwise_r2_20260801` 使用 stationwise average R²，不能混入 global R² 表格。**
