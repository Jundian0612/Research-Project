...
- [舊裝置 Stage 1](../20260908_STDK_QConvLSTM_Weather2K_q50_interface_tuning/README.md)
- [新裝置前次 Stage 2](../20260909_STDK_QConvLSTM_Weather2K_q50_capacity_tuning/README.md)
- [Seed 42 同機重跑檢查](../20260909_STDK_QConvLSTM_Weather2K_seed42_repro_check/README.md)

## 資料夾結構

```text
20260909_qconvlstm_retune_rtx2000/
├── README.md
├── trials/
...
└── provenance/
    ...
    └── 20260910_incomplete_formal_seed41/ # 舊規則中止的 seed41 紀錄
```
...
PYTHONUNBUFFERED=1 python -u weather2k_exp/tune_stdk_qconvlstm_hyperparams.py \
  ...
  --output-dir weather2k_exp/air_temperature/20260909_qconvlstm_retune_rtx2000
```
