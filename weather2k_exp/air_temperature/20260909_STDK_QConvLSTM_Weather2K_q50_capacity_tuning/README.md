...
本輪沿用 [舊裝置 Stage 1](../20260908_STDK_QConvLSTM_Weather2K_q50_interface_tuning/README.md)
...
seed 42 同設定跨裝置 RMSE 有明顯差異；[新裝置重跑檢查](../20260909_STDK_QConvLSTM_Weather2K_seed42_repro_check/README.md)
只出現小幅波動，原因尚未完全定位。
