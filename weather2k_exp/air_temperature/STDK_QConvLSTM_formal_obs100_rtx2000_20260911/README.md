...
參數來源是相鄰的 `qconvlstm_obs100_tuning_20260910`：grid=5、radius=0.1、filters=32、
...
python -m pip freeze > weather2k_exp/air_temperature/STDK_QConvLSTM_formal_obs100_rtx2000_20260911/metadata/pip-freeze.txt
set -o pipefail
PYTHONUNBUFFERED=1 python -u weather2k_exp/2K_STDK_QConvLSTM.py \
  --params-file weather2k_exp/air_temperature/STDK_QConvLSTM_formal_obs100_rtx2000_20260911/params/locked_params.json \
  --seed 41 --forecast-mode block5to5 --prediction-mode direct \
  --output-dir weather2k_exp/air_temperature/STDK_QConvLSTM_formal_obs100_rtx2000_20260911 \
  2>&1 | tee -a weather2k_exp/air_temperature/STDK_QConvLSTM_formal_obs100_rtx2000_20260911/logs/seed41.log
```
